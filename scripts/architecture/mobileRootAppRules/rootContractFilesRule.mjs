export function inspectRootContractFiles(rel, violations) {
  if (rel.match(/^app\/(?:appShellTypes|appTypes|studyAnimationTypes)\.ts$/)) {
    violations.rootContractFiles.push(`${rel}: keep app contracts inside focused contract folders`);
  }
