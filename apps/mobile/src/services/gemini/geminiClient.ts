...
const MISSING_KEY_MESSAGE = "Gemini tutor is not configured for this build. Add EXPO_PUBLIC_GEMINI_API_KEY to enable online tutoring; offline study still works.";
