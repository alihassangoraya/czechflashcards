...
export function HomeHero({ activeDeckLabel, examLevel, dueCount, accountEmail, accountName, wide, onStartStudy, onStartQuiz, onOpenProgress, onSearch, onAdd, onSettings, onAccount }: HomeHeroProps) {
  const { t } = useI18n();
  ...
  return (
    <ImageBackground source={pragueHero as never} style={[styles.hero, wide && styles.heroWide]} imageStyle={styles.heroImage} resizeMode="cover">
      ...
      <HomeHeroCopy dueCount={dueCount} accountName={accountName} />
