...
import type { buildHomeScreenModel } from "../homeScreenModel";
import type { HomeScreenProps } from "../homeScreenTypes";

type HomeModel = ReturnType<typeof buildHomeScreenModel>;

type Props = Pick<HomeScreenProps, "deck" | "settings" | "onSelectCategory"> & {
  model: HomeModel;
};

export function HomeContent({ deck, settings, model, onSelectCategory }: Props) {
  return (
