...
type Props = { card: Card; saved: boolean; onToggleSaved: (card: Card) => void; onManageDecks: (card: Card) => void; onEdit: (card: Card) => void };
...
const styles = StyleSheet.create({
  actions: { flexDirection: "row", flexWrap: "wrap", justifyContent: "flex-end", gap: spacing.smd }
});
