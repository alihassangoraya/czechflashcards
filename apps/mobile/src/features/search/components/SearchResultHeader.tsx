...
export function SearchResultHeader({ card }: Props) {
  ...
  const compact = width < size.searchResultCompactBreakpoint;
...
const styles = StyleSheet.create({
  ...
  compactTopLine: { flexDirection: "column", alignItems: "flex-start", gap: spacing.xs },
  ...
  compactBadges: { justifyContent: "flex-start", alignSelf: "flex-start" },
