...
export function applyAgainGrade(next, state, reviewedAt) {
  next.knownStreak = 0;
...
export function applyHardGrade(next, state, reviewedAt) {
...
export function applyEasyGrade(next, state, reviewedAt) {
...
export function applyGoodGrade(next, state, reviewedAt) {
